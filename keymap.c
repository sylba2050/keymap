...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  /* Qwerty
     ...
     * `-------------------------------------------------. ,--------------------------------------------------'
     *                     | GUIEI  | Del/L1 | SPACE     | | ENT | Bsp/L1 | ALTKN |
     *                     `-----------------------------' `------------------------'
     */
  [_QWERTY] = LAYOUT(
  ...
  [_LOWER] = LAYOUT(
        ...
        KC_LSFT, KC_F11, KC_F12, KC_TRNS, KC_TRNS, KC_TRNS,     KC_0,    KC_1, KC_2, KC_3, KC_ASTR, KC_RSFT,
                                KC_LCTL, MO(_LOWER), KC_ESC,      KC_SPC, KC_BSPC, KC_0
  ),
